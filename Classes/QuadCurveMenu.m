...
#define STARTPOINT CGPointMake(50, 950)
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"rosetta_on.png"]
                                       highlightedImage:[UIImage imageNamed:@"rosetta_pressed.png"] 
